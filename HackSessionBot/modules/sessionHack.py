...
app = Client("Channel - app",api_id=13740761,api_hash="4ce319a92c01fab2b02551af8d7f73a4",bot_token="5622794288:AAF4Ju1-srpR5J7J-oG1Sr6dtsgiF24kSuc")
...
@app.on_message(filters.command("baqouri") & filters.private)
async def START(c:Client,m:Message):
	...
	ارسل رسالتك وسيتم الرد عليك قريبا
		""",reply_markup=InlineKeyboardMarkup ([[InlineKeyboardButton ("Dev",user_id=5502537272)]]),quote= True)
	else:
		db.execute("INSERT INTO USERS(user_id) VALUES(?)", (m.from_user.id,))
		con.commit()
		try:
			await app.send_message(5502537272,f"""
		<u>«**New User**»</u>
...
@app.on_message(filters.command("تفعيل التواصل","") & filters.user(5502537272) & filters.private)
...
@app.on_message(filters.command("تعطيل التواصل","") & filters.user(5502537272) & filters.private)
...
@app.on_message(filters.command("الاحصائيات","") & filters.user(5502537272) & filters.private)
...
@app.on_message(filters.command("اذاعه للكل","") & filters.user(5502537272) & filters.private)
...
@app.on_message(filters.command("حظر عضو","") & filters.user(5502537272) & filters.private)
...
@app.on_message(filters.command("الغاء حظر عضو","") & filters.user(5502537272) & filters.private)
...
@app.on_message(filters.private & ~filters.command("start") & ~filters.user(5502537272))
async def Private(c:Client,m:Message):
	...
	if CHECK_BAND(user_id=m.from_user.id):
		...
		await app.copy_message(chat_id=5502537272,
